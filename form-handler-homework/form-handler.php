<?php
    ...
    if ($phoneNumber === ""){
        //honeypot is emtpy and form should be processed
    }
    else {
        //form should not be processed
...
<body>
    <div id="confirmationContainer">
        <h1>Thank you <?php echo $firstName . " " .$lastName ?>, For signing up for our newsletter</h1>
        <h2>A conformation has been sent to <?php echo "$email "?>. Thank you for your support!</h2>
    </div>
</body>
</html>